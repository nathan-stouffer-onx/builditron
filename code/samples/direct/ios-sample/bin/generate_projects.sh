...
echo "Generating Xcode project for simulator..."
(cd "$SAMPLES_DIR/ios-sample-simulator" && tuist generate)

echo "Generating Xcode project for device..."
(cd "$SAMPLES_DIR/ios-sample-device" && tuist generate)
